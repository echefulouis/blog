          ...
          <div class="item">
            ...
            <div class="item-content">
              <div class="main-content">
                ...
                <a href="{{route('post-details')}}"><h4>Morbi dapibus condimentum</h4></a>
                <ul class="post-info">
          ...
          <div class="item">
            ...
            <div class="item-content">
              <div class="main-content">
                ...
                <a href="{{route('post-details')}}"><h4>Donec porttitor augue at velit</h4></a>
                <ul class="post-info">
                  <li><a href="#">Admin</a></li>
          ...
          <div class="item">
            ...
            <div class="item-content">
              <div class="main-content">
                ...
                <a href="{{route('post-details')}}"><h4>Best HTML Templates on TemplateMo</h4></a>
                <ul class="post-info">
                  <li><a href="#">Admin</a></li>
          ...
          <div class="item">
            ...
            <div class="item-content">
              <div class="main-content">
                ...
                <a href="{{route('post-details')}}"><h4>Responsive and Mobile Ready Layouts</h4></a>
                <ul class="post-info">
                  <li><a href="#">Admin</a></li>
          ...
          <div class="item">
            ...
            <div class="item-content">
              <div class="main-content">
                ...
                <a href="{{route('post-details')}}"><h4>Cras congue sed augue id ullamcorper</h4></a>
                <ul class="post-info">
                  <li><a href="#">Admin</a></li>
          ...
          <div class="item">
            ...
            <div class="item-content">
              <div class="main-content">
                ...
                <a href="{{route('post-details')}}"><h4>Suspendisse nec aliquet ligula</h4></a>
                <ul class="post-info">
                  <li><a href="#">Admin</a></li>
              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="blog-post">
                    ...
                    <div class="down-content">
                      <span>Lifestyle</span>
                      <a href="{{route('post-details')}}"><h4>Best Template Website for HTML CSS</h4></a>
                      <ul class="post-info">
                        <li><a href="#">Admin</a></li>
                ...
                <div class="col-lg-12">
                  <div class="blog-post">
                    ...
                    <div class="down-content">
                      <span>Healthy</span>
                      <a href="{{route('post-details')}}"><h4>Etiam id diam vitae lorem dictum</h4></a>
                      <ul class="post-info">
                        <li><a href="#">Admin</a></li>
                        <li><a href="#">May 24, 2020</a></li>
                        <li><a href="#">36 Comments</a></li>
                ...
                <div class="col-lg-12">
                  <div class="blog-post">
                    ...
                    <div class="down-content">
                      <span>Fashion</span>
                    <a href="{{route('post-details')}}"><h4>Donec tincidunt leo nec magna</h4></a>
                      <ul class="post-info">
                        <li><a href="#">Admin</a></li>
                        <li><a href="#">May 14, 2020</a></li>
                        <li><a href="#">48 Comments</a></li>
